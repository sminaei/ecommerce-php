            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    ...
                    while ( $cat_row = mysqli_fetch_array($cat_query)):
                        ?>
                        <a href="index.php?cat=<?php echo $cat_row['id']?>"
                           class="list-group-item"><?php echo $cat_row['cat_name']?></a>
                    <?php endwhile; ?>
            ...
            <div class="col-lg-9">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-footer">
                        ...
                        <!-- لینک از صفحه سینگل به صفحه اصلی با دسته بندی های مورد نظر را نمایش می دهد
                        -->
